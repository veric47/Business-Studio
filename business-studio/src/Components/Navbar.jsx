    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 60 }}>
        ...
        <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
          <div style={{ width: 32, height: 32, background: 'var(--accent)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16 }}>B</div>
          <span style={{ fontWeight: 700, fontSize: 18, color: 'var(--text-h)' }}>
            Business<span style={{ color: 'var(--accent2)' }}>Studio</span>
          </span>
        </Link>
            ...
            <>
              ...
              <div style={{ position: 'relative' }}>
                <button
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: 8, background: 'var(--bg3)', border: '1px solid var(--border)', borderRadius: 100, padding: '4px 12px 4px 4px', cursor: 'pointer' }}
                >
                ...
                {menuOpen && (
                  <div style={{ position: 'absolute', right: 0, top: '110%', background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', padding: 8, minWidth: 180, boxShadow: '0 16px 40px rgba(0,0,0,0.4)' }}>
                    <div style={{ padding: '8px 12px', borderBottom: '1px solid var(--border)', marginBottom: 4 }}>
                      ...
                      <span className="badge badge-purple" style={{ marginTop: 6 }}>{user.plan === 'premium' ? '⭐ Premium' : 'Free Plan'}</span>
                    </div>
